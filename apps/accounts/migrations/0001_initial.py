# Generated by Django 4.2.10 on 2024-08-01 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='utils.imagemodel', verbose_name='تصویر')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['-created_at'], name='accounts_us_created_1d23db_idx')],
            },
        ),
    ]
